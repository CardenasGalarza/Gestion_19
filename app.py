...
cnxn = mysql.connector.connect( host="bz1pjf02mwmqcoxims5w-mysql.services.clever-cloud.com",
                                port="3306",
                                user="ut7gdtw2rf49rjax",
                                passwd="UkWp9Zo6mhMIDr3J3IPS",
                                db="bz1pjf02mwmqcoxims5w"
                                )
cursor = cnxn.cursor()
